                ...
                <div className="App">
                    ...
                    <div className="container">
                        ...
                        <Routes>
                            ...
                            <Route exact path="/user/:login" element={ < User getUser={this.getUser} user={this.state.user} loading={this.state.loading} getUserRepos={this.getUserRepos} repos={this.state.repos} /> }>
                            </Route>
                        </Routes>
                    </div>
                </div>
